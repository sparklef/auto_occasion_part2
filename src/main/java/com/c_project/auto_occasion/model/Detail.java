...
public class Detail {
    ...
    public Detail(int idDetail, String couleur, int nbr_portes, String boite_devitesse, String source_energie, int annee, String modele) {
        this.idDetail = idDetail;
        this.couleur = couleur;
        this.nbr_portes = nbr_portes;
        this.boite_devitesse = boite_devitesse;
    ...
    public Detail(String couleur, int nbr_portes, String boite_devitesse, String source_energie, int annee,
